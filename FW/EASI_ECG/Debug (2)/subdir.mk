...
ads1294.obj: ../ads1294.c $(GEN_SRCS) $(GEN_OPTS)
	...
	"C:/Program Files (x86)/Texas Instruments/ccsv4/tools/compiler/c5500/bin/cl55" -v5505 -g --include_path="C:/dsplib_2.40.00/include" --include_path="C:/Program Files (x86)/Texas Instruments/ccsv4/tools/compiler/c5500/include" --include_path="C:/Users/mark/Google Drive/EE4981H/Software/FW/EASI_ECG/include" --include_path="C:/c55xx_csl_3.00/inc" --diag_warning=225 --sat_reassoc=off --ptrdiff_size=16 --fp_reassoc=off --memory_model=large --asm_source=mnemonic $(GEN_OPTS_QUOTED) --preproc_with_compile --preproc_dependency="ads1294.pp" $(subst #,$(wildcard $(subst $(SPACE),\$(SPACE),$<)),"#")
